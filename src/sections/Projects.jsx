...
const PROJECTS = Object.freeze([
  {
    ...
    description:
      "A production-ready healthcare booking platform connecting patients, doctors, and administrators with real-time slot management and a powerful admin dashboard.",
    features: [
  ...
  },
  {
    ...
    subtitle: "Full-Stack MERN Restaurant & Ordering Platform",
    category: "fullstack",
    desktop: f1,
    mobile: s4,
    live: "https://food-delivery-app-pink-iota.vercel.app/",
    github: "https://github.com/codecsuman/food-delivery-app",
    description:
      "A full-stack food delivery platform connecting restaurant owners and customers — restaurant owners manage their storefront, menu, and incoming orders, while customers browse, search, and order with live status tracking and Stripe checkout.",
    features: [
      "Every signed-up user is admin-enabled to run a restaurant",
      "Dashboard to create & manage a restaurant storefront",
      "Dashboard to add menu items with images",
      "Dashboard to manage incoming orders",
      "Live search & filtering by name, city & cuisine",
  ...
  },
  {
    ...
    description:
      "A full-stack job portal connecting job seekers and employers with smart filtering, authentication, and a dedicated recruiter dashboard.",
    features: [
  ...
  },
  {
    ...
    description:
      "A social media app inspired by Instagram featuring real-time updates, post interactions, and live notifications powered by Socket.io.",
    features: [
      "JWT authentication",
  ...
  },
  {
    ...
    description:
      "Comprehensive analysis of Blinkit's grocery sales dataset using Microsoft Excel — featuring an interactive slicer-driven dashboard for stakeholders to explore KPIs and outlet performance.",
    features: [
  ...
  },
  {
    ...
    description:
      "A complete EDA project on a synthetic retail sales dataset — covering data generation, analysis, and interactive visualization across revenue, profit, region, and customer segments.",
    features: [
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div
          ...
          style={{
            ...
            padding: "2rem 2.5rem",
            transition:
              "opacity 220ms ease, transform 220ms ease, border-color 0.3s ease",
              ...
              {filtered.map((p, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "999px",
                    background:
                      i === index ? p.color : "rgba(255,255,255,0.12)",
                    border: "none",
                    cursor: "pointer",
                    padding: 0,
